        ...
        <section>
            <div class="empRequestContiner">
                <div class="leavingMNavBtnCon">
                    ...
                    <button class="unclickedBtn" onclick="approved()">Approved Requests</button>
                    <button class="clickedBtn" onclick="rejected()">Rejected Requests</button>
                </div>
                ...
                <%
                        ...
                        try{
                            ...
                            String str = "SELECT * FROM leavingrequest WHERE status='Rejected'";
